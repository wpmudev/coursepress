<script type="text/template" id="coursepress-course-type-tpl">
	<div class="cp-box-heading">
		<h2 class="box-heading-title"><?php esc_html_e( 'Pick name and type of course to create', 'cp' ); ?></h2>
	</div>
    <div class="cp-box-content">
        <div class="box-label-area">
            <h3 class="label"><?php esc_html_e( 'Course name and language', 'cp' ); ?></h3>
        </div>
        <div class="box-inner-content">
            <div class="cp-box">
                <label class="label"><?php esc_html_e( 'Course Name', 'cp' ); ?></label>
                <input type="text" class="widefat" name="post_title" value="{{post_title}}" />
            </div>

            <div class="cp-box">
                <label class="label"><?php esc_html_e( 'Course Slug', 'cp' ); ?></label>
                <input type="text" class="widefat" name="post_name" value="{{post_name}}" />
                <p class="description"><?php echo esc_html( coursepress_get_url() ); ?><span class="cp-slug">{{post_name}}</span>/</p>
            </div>

            <div class="cp-box">
                <label class="label"><?php esc_html_e( 'Language', 'cp' ); ?></label>
    ...
    <div class="cp-box-content">
        <div class="box-label-area">
            <h3 class="label"><?php esc_html_e( 'Course type', 'cp' ); ?></h3>
            <p class="description"><?php esc_html_e( 'Pick a type of course you want to create', 'cp' ); ?></p>
        </div>
        <div class="box-inner-content">
            <div class="cp-box">
                <label class="label"><?php esc_html_e( 'Pick course type or load example course', 'cp' ); ?></label>
                <ul class="cp-flex cp-input-group">
                    <li class="cp-div-flex {{'auto-moderated'===course_type?'active':''}}">
                        <label>
                            ...
                            <?php esc_html_e( 'Auto-moderated', 'cp' ); ?>
                        </label>
                    </li>
                    <li class="cp-div-flex {{'manual'===course_type?'active':''}}">
                        <label>
                            ...
                            <?php esc_html_e( 'Manual moderation', 'cp' ); ?>
                        </label>
                    </li>
                    <li class="cp-div-flex {{'sample'===course_type?'active':''}}">
                        <label>
                            ...
                            <?php esc_html_e( 'Example course', 'cp' ); ?>
                        </label>
                    </li>
                </ul>
            </div>
            ...
            <div class="cp-box cp-course-type {{'auto-moderated'===course_type?'active':'inactive'}}" id="type-auto-moderated">
                <div class="cp-alert cp-alert-info">
                    <p><?php esc_html_e( 'All grading is done manually, any number of students can enroll in this course at any time. Similar to Envato & Treehouse courses. Instructors can participate in discussion.', 'cp' ); ?></p>
                    <p><?php esc_html_e( '(These settings can be changed at any time).', 'cp' ); ?></p>
                </div>
            </div>

            <div class="cp-box cp-sep cp-course-type {{'manual'===course_type?'active':'inactive'}}" id="type-manual">
                <div class="cp-box">
                    <label class="label"><?php esc_html_e( 'Class Size', 'cp' ); ?></label>
                    <p><?php esc_html_e( 'Number of students', 'cp' ); ?> <input type="number" name="meta_class_size" class="input-inline" min="0" value="{{class_size}}" /> <span class="description"><?php esc_html_e( 'Set "0" to unlimited size.', 'cp' ); ?></span> </p>
                </div>

				<div class="cp-box">
                    <label class="label"><?php esc_html_e( 'Course Availability', 'cp' ); ?></label>
                    <div class="cp-toggle-box">
                        ...
                        <p class="description"><?php esc_html_e( 'These are the dates that the course will be available to students.', 'cp' ); ?></p>
                    </div>
                    <div class="cp-flex">
                        <div class="cp-div-flex cp-pad-right">
                            <span class="course-title-tag"><?php esc_html_e( 'Start Date', 'cp' ); ?></span>
                        ...
                        <div class="cp-div-flex cp-pad-left">
                            <span class="course-title-tag"><?php esc_html_e( 'End Date', 'cp' ); ?></span>
				...
				<div class="cp-box">
                    <label class="label"><?php esc_html_e( 'Enrollment Date', 'cp' ); ?></label>
                    <div class="cp-toggle-box">
                        <label>
            ...
            <div class="cp-box cp-sep cp-course-type {{'sample_course'===course_type?'active':'inactive'}}" id="type-sample">
                <p class="description"><?php esc_html_e( 'Choose a sample course to use and edit it\'s units, modules and steps.', 'cp' ); ?></p>
                <button type="button" class="cp-btn cp-btn-active sample-course-btn"><?php esc_html_e( 'Select Sample Course', 'cp' ); ?></button>
            </div>
            ...
            <div class="cp-box cp-toggle-box cp-sep">
                <label>
                    ...
                    <span class="label"><?php esc_html_e( 'Enable course discussion', 'cp' ); ?></span>
                </label>
                <p class="description"><?php esc_html_e( 'Creates discussion area where users can post questions and get help from instructors, facilitators and other students', 'cp' ); ?></p>
            </div>
            ...
            <div class="cp-box cp-toggle-box cp-sep">
                <label>
                    ...
                    <span class="label"><?php esc_html_e( 'Enable workbook', 'cp' ); ?></span>
                </label>
                <p class="description"><?php esc_html_e( 'Users can access their workbook which will show their progress/scores for the course.', 'cp' ); ?></p>
            </div>
            ...
            <div class="cp-box cp-toggle-box cp-sep">
                <label>
                    ...
                    <span class="label"><?php esc_html_e( 'Show student grades', 'cp' ); ?></span>
                </label>
                <p class="description"><?php esc_html_e( 'If enabled, students can see their grades.', 'cp' ); ?></p>
            </div>
            ...
            <div class="cp-box cp-toggle-box">
                <label>
                    ...
                    <span class="label"><?php esc_html_e( 'This is a paid course', 'cp' ); ?></span>
                </label>
                <p class="description"><?php esc_html_e( 'Will allow you to set-up payment gateway/options.', 'cp' ); ?></p>
    <div class="cp-box cp-box-error cp-box-payment{{  "1" === meta_payment_paid_course? '':' hidden' }}">
        <div class="payment-message">
            <h3><?php esc_html_e( 'Sell your courses online with MarketPress.', 'cp' ); ?></h3>
            <p><?php esc_html_e( 'To start selling your course, please install and activate MarketPress or contact your administrator to enable MarketPress for your site.', 'cp' ); ?></p>
            <p><?php esc_html_e( 'Other supported plugins: WooCommerce', 'cp' ); ?></p>
        </div>
    </div>
            </div>
        </div>
    ...
    <div class="cp-box-content cp-box-marketpress{{  true === meta_payment_paid_course? '':' hidden' }}">
        <div class="box-label-area">
            <h3 class="label"><?php esc_html_e( 'MarketPress Product Settings', 'cp' ); ?></h3>
            <p class="description"><?php esc_html_e( 'Your course will be a new product in MarketPress. Enter your course\'s payment settings below.', 'cp' ); ?></p>
        </div>
    ...
    <div class="cp-box-content cp-box-woocommerce {{  true == payment_paid_course? '':' hidden' }}">
        <div class="box-label-area">
            <h3 class="label"><?php esc_html_e( 'WooCommerce Product Settings', 'cp' ); ?></h3>
            <p class="description"><?php esc_html_e( 'Your course will be a new product in WooCommerce. Enter your course\'s payment settings.', 'cp' ); ?></p>
        </div>
        <div class="box-inner-content">
    ...
    <div class="coursepress-popup-body">
        <div class="coursepress-popup-heading">
            <div class="coursepress-popup-title">
                <h3><?php esc_html_e( 'Choose Sample Course', 'cp' ); ?></h3>
            </div>
            ...
            <ul>
		        <?php foreach ( $sample_courses as $id => $sample ) : ?>
                    <li>
                        <div class="cp-toggle-box">
                            <label>
                                <input type="radio" name="meta_sample_course" value="<?php echo esc_attr( $sample['file'] ); ?>" class="cp-toggle-input" autocomplete="off" /> <span class="cp-toggle-btn"></span>
                                <span class="label"><?php echo esc_html( $sample['title'] ); ?></span>
                            </label>
                        </div>
                    </li>
		        <?php endforeach; ?>
        ...
        <div class="coursepress-popup-footer">
            <button type="button" class="cp-btn cp-btn-active"><?php esc_html_e( 'Use Selected', 'cp' ); ?></button>
        </div>
    </div>
</script>
