<script type="text/template" id="coursepress-slugs-setting-tpl">
	...
	<div class="cp-content">
		...
		$config['course_category'] = array(
			'title' => esc_html__( 'Course category', 'cp' ),
			'fields' => array(
				'category' => array(
					'type' => 'text',
		...
		$config['step'] = array(
			...
			'fields' => array(
				...
				'desc' => array(
					'type' => 'html_text',
					'value' => esc_html__( 'This string will be use only for no module courses', 'cp' ),
					'class' => 'description',
				),
			),
		);
		$config['notifications'] = array(
			'title' => esc_html__( 'Course notifications', 'cp' ),
			'fields' => array(
				'notifications' => array(
					'type' => 'text',
		...
		$config['discussions'] = array(
			'title' => esc_html__( 'Course discussions', 'cp' ),
			'fields' => array(
				'discussions' => array(
					'type' => 'text',
		...
		$config['discussions_new'] = array(
			'title' => esc_html__( 'Course new discussion', 'cp' ),
			'fields' => array(
		...
		$config['workbook'] = array(
			'title' => esc_html__( 'Course workbook', 'cp' ),
			'fields' => array(
				'workbook' => array(
					'type' => 'text',
		...
		$config['instructor_profile'] = array(
			'title' => esc_html__( 'Instructor profile', 'cp' ),
			'fields' => array(
		...
		$pages_options = array( esc_html__( 'use virtual page', 'cp' ) );
		...
		$config['dashboard'] = array(
			'title' => esc_html__( 'Student dashboard', 'cp' ),
			'fields' => array(
		...
		$config['settings'] = array(
			'title' => esc_html__( 'Student settings', 'cp' ),
			'fields' => array(
