    ...
    <div class="step-content step-sep">
        ...
        <div class="step-inner-content">
            ...
            <div class="cp-box">
                ...
                <textarea name="post_excerpt" id="course-excerpt" rows="5">{{post_excerpt}}</textarea>
            </div>
        </div>
    </div>
    ...
    <div class="step-content cp-sep">
        ...
        <div class="step-inner-content">
            <div class="cp-box">
                ...
                <textarea name="post_content" id="course-description" rows="10">{{post_content}}</textarea>
            </div>
            ...
            <div class="cp-box">
                ...
                <div class="cp-flex cp-flex-2">
                    <div class="cp-div-left">
                        <input type="text" class="cp-add-video" name="featured_video" placeholder="<?php _e( 'Paste URL or browse uploaded files', 'cp' ); ?>" data-id="0" data-title="<?php _e( 'Select Feature Image', 'cp' ); ?>" />
                    </div>
        ...
        <div class="step-inner-content">
            <div class="cp-box cp-toggle-box">
                <label>
		            ...
		            <?php _e( 'Enable modules for this course', 'cp' ); ?>
                </label>
    ...
    <div class="step-content cp-sep">
        ...
        <div class="step-inner-content">
            ...
            <div class="cp-box">
                ...
                <input type="text" id="pre-completion-title" name="meta_pre_completion_title" value="{{pre_completion_title}}" />
            </div>
            <div class="cp-box">
                <label class="label" for="pre-completion-content"><?php _e( 'Content', 'cp' ); ?></label>
                <textarea id="pre-completion-content" name="meta_pre_completion_content" rows="5">{{pre_completion_content}}</textarea>
            </div>
        </div>
    </div>
