 ...
 */
?>
<div class="wrap coursepress-wrap coursepress-comments" id="coursepress-comments">
...
switch ( $column_id ) {
	...
	default :
		...
		/**
				 ...
				 */
		do_action( 'coursepress_comments_column', $column_id, $forum );
	break;
}
?>
                                </td>
