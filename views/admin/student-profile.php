<?php
	 ...
	 */
	$courses = $student->get_enrolled_courses_ids();
?>
...
<div class="coursepress-wrap">
    <div class="coursepress-student-data">
        ...
        <div class="coursepress-data-table">
            <ul>
                <li><span><?php esc_html_e('Student ID', 'cp'); ?></span><?php echo $student->__get('ID'); ?></li>
                <li><span><?php esc_html_e('First Name', 'cp'); ?></span><?php echo $student->__get('first_name'); ?></li>
                <li><span><?php esc_html_e('Last Name', 'cp'); ?></span><?php echo $student->__get('last_name'); ?></li>
                <li><span><?php esc_html_e('Display Name', 'cp'); ?></span><?php echo $student->__get('display_name'); ?></li>
                <li><span><?php esc_html_e('Email', 'cp'); ?></span><?php echo $student->__get('user_email'); ?></li>
                <li><span><?php esc_html_e('Registered', 'cp'); ?></span><?php echo $student->__get('user_registered'); ?></li>
            </ul>
        </div>
    </div>
