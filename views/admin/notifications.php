...
<div class="wrap coursepress-wrap coursepress-notifications" id="coursepress-notifications">
	<h1 class="wp-heading-inline">
		<?php esc_html_e( 'Notifications', 'cp' ); ?>
	</h1>

	<div class="coursepress-page ">

		<ul class="cp-notification-menu">
			<li class="cp-notification-menu-item notification-alerts" data-page="alerts" data-tab="alerts"><?php esc_html_e( 'Course Alerts', 'cp' ); ?></li>
			<li class="cp-notification-menu-item notification-emails" data-page="emails" data-tab="emails"><?php esc_html_e( 'Notification Emails', 'cp' ); ?></li>
		</ul>
