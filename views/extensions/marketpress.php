    ...
    <div class="box-inner-content">
        <div class="cp-box cp-toggle-box">
            <label>
                ...
                <span class="label"><?php printf( __( 'Use %s to sell courses.', 'cp' ), __( 'MarketPress', 'cp' ) ); ?></span>
            </label>
            <p class="description"><?php printf( __( 'When checked, %s will be use to sell courses.', 'cp' ), __( 'MarketPress', 'cp' ) ); ?></p>
        </div>
        ...
        <div class="cp-box cp-toggle-box cp-sep">
            <label>
                ...
                <span class="label"><?php printf( __( 'Redirect %s product to course product.', 'cp' ), __( 'MarketPress', 'cp' ) ); ?></span>
            </label>
            <p class="description"><?php printf( __( 'Visitors who will try to access %s single product will be redirected to course overview.', 'cp' ), __( 'MarketPress', 'cp' ) ); ?></p>
        </div>
    </div>
    ...
    <div class="box-inner-content">
        ...
        <div class="cp-box cp-toggle-box cp-sep">
            <label>
                ...
                <span class="label"><?php printf( __( 'Remove %s related product.', 'cp' ), __( 'MarketPress', 'cp' ) ); ?></span>
            </label>
        </div>
    </div>
