<form method="post" action="<?php echo esc_url( $course->get_discussion_url()) ?>">
...
?>
    <input name="title" type="text" placeholder="<?php esc_attr_e( 'Title of the discussion', 'cp' ); ?>" value="" />
    <textarea name="content" placeholder="<?php esc_attr_e( 'Type your discussion or question here…', 'cp' ); ?>"></textarea>
    <div class="button-links">
        <a href="' . esc_url( $cancel_link ) . '" class="button"><?php esc_html_e( 'Cancel', 'cp' ); ?></a>
