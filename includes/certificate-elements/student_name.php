...
if ( ! class_exists( 'cp_student_name_element' ) ) {
	class cp_student_name_element extends CP_Certificate_Template_Elements {
		...
		function on_creation() {
			$this->element_title = apply_filters( 'coursepress_student_name_element_title', __( 'Student Name', 'coursepress' ) );
		}
	...
	cp_register_template_element( 'cp_student_name_element', __( 'Student Name', 'coursepress' ) );
}