...
if ( ! class_exists( 'cp_issue_date_element' ) ) {
	class cp_issue_date_element extends CP_Certificate_Template_Elements {
		...
		function on_creation() {
			$this->element_title = apply_filters( 'coursepress_issue_date_element_title', __( 'Issue Date', '<%= wpmudev.plugin.textdomain %>' ) );
		}
	...
	cp_register_template_element( 'cp_issue_date_element', __( 'Issue Date', '<%= wpmudev.plugin.textdomain %>' ) );
}