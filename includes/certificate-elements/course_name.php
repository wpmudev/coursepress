...
if ( ! class_exists( 'cp_course_name_element' ) ) {
	class cp_course_name_element extends CP_Certificate_Template_Elements {
		...
		function on_creation() {
			$this->element_title = apply_filters( 'coursepress_course_name_element_title', __( 'Course Name', 'coursepress' ) );
		}
	...
	cp_register_template_element( 'cp_course_name_element', __( 'Course Name', 'coursepress' ) );
}