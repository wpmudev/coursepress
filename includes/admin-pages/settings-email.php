...
<div id="poststuff" class="metabox-holder m-settings email-settings cp-wrap">
	<form action='' method='post'>
		...
		?>
		<div class="postbox">
			<h3 class="hndle" style='cursor:auto;'><span><?php _e( 'User Registration E-mail', 'coursepress' ); ?></span></h3>

			<div class="inside">
				<p class="description"><?php _e( 'Settings for an e-mail student get upon account registration.', 'coursepress' ); ?></p>
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<p class="description"><?php _e( 'These codes will be replaced with actual data: STUDENT_FIRST_NAME, STUDENT_USERNAME, STUDENT_PASSWORD, BLOG_NAME, LOGIN_ADDRESS, COURSES_ADDRESS, WEBSITE_ADDRESS', 'coursepress' ); ?></p>
							<?php
		...
		<div class="postbox">
			<h3 class="hndle" style='cursor:auto;'>
				<span><?php _e( 'Course Enrollment Confirmation E-mail', 'coursepress' ); ?></span></h3>

			<div class="inside">
				<p class="description"><?php _e( 'Settings for an e-mail student get upon enrollment', 'coursepress' ); ?></p>
				<table class="form-table">
					<tbody id="items">
					<tr>
						<th><?php _e( 'From Name', 'coursepress' ); ?></th>
					...
					<tr>
						<th><?php _e( 'E-mail Content', 'coursepress' ); ?></th>
						<td>
							<p class="description"><?php _e( 'These codes will be replaced with actual data: STUDENT_FIRST_NAME, BLOG_NAME, LOGIN_ADDRESS, COURSES_ADDRESS, WEBSITE_ADDRESS, COURSE_ADDRESS', 'coursepress' ); ?></p>
							<?php
		...
		<?php if ( $this->is_marketpress_active() ) { ?>
			<div class="postbox">
				<h3 class="hndle" style='cursor:auto;'><span><?php _e( 'MarketPress New Order E-mail', 'coursepress' ); ?></span>
				</h3>

				<div class="inside">
					<p class="description"><?php _e( 'Settings for an e-mail student get upon placing an order', 'coursepress' ); ?></p>
					<table class="form-table">
						<tbody id="items">
						<tr>
							<th><?php _e( 'From Name', 'coursepress' ); ?></th>
						...
						<tr>
							<th><?php _e( 'E-mail Content', 'coursepress' ); ?></th>
							<td>
								<p class="description"><?php _e( 'These codes will be replaced with actual data: CUSTOMER_NAME, BLOG_NAME, LOGIN_ADDRESS, COURSES_ADDRESS, WEBSITE_ADDRESS, COURSE_ADDRESS, ORDER_ID, ORDER_STATUS_URL', 'coursepress' ); ?></p>
								<?php
		...
		<div class="postbox">
			<h3 class="hndle" style='cursor:auto;'>
				<span><?php _e( 'Student Invitation to a Course E-mail', 'coursepress' ); ?></span></h3>

			<div class="inside">
				<p class="description"><?php _e( 'Settings for an e-mail student get upon receiving an invitation to a course.', 'coursepress' ); ?></p>
				<table class="form-table">
					<tbody id="items">
					<tr>
						<th><?php _e( 'From Name', 'coursepress' ); ?></th>
					...
					<tr>
						<th><?php _e( 'E-mail Content', 'coursepress' ); ?></th>
						<td>
							<p class="description"><?php _e( 'These codes will be replaced with actual data: STUDENT_FIRST_NAME, COURSE_NAME, COURSE_EXCERPT, COURSE_ADDRESS, WEBSITE_ADDRESS', 'coursepress' ); ?></p>
							<?php
		...
		<div class="postbox">
			<h3 class="hndle" style='cursor:auto;'>
				<span><?php _e( 'Student Invitation with Passcode to a Course E-mail', 'coursepress' ); ?></span></h3>

			<div class="inside">
				<p class="description"><?php _e( 'Settings for an e-mail student get upon receiving an invitation ( with passcode ) to a course.', 'coursepress' ); ?></p>
				<table class="form-table">
					<tbody id="items">
					<tr>
						<th><?php _e( 'From Name', 'coursepress' ); ?></th>
					...
					<tr>
						<th><?php _e( 'E-mail Content', 'coursepress' ); ?></th>
						<td>
							<p class="description"><?php _e( 'These codes will be replaced with actual data: STUDENT_FIRST_NAME, COURSE_NAME, COURSE_EXCERPT, COURSE_ADDRESS, WEBSITE_ADDRESS, PASSCODE', 'coursepress' ); ?></p>
							<?php
		...
		<div class="postbox">
			<h3 class="hndle" style='cursor:auto;'><span><?php _e( 'Instructor Invitation E-mail', 'coursepress' ); ?></span>
			</h3>

			<div class="inside">
				<p class="description"><?php _e( 'Settings for an e-mail an instructor will get upon receiving an invitation.', 'coursepress' ); ?></p>
				<table class="form-table">
					<tbody id="items">
					<tr>
						<th><?php _e( 'From Name', 'coursepress' ); ?></th>
					...
					<tr>
						<th><?php _e( 'E-mail Content', 'coursepress' ); ?></th>
						<td>
							<p class="description"><?php _e( 'These codes will be replaced with actual data: INSTRUCTOR_FIRST_NAME, INSTRUCTOR_LAST_NAME, INSTRUCTOR_EMAIL, CONFIRMATION_LINK, COURSE_NAME, COURSE_EXCERPT, COURSE_ADDRESS, WEBSITE_ADDRESS, WEBSITE_NAME', 'coursepress' ); ?></p>
							<?php
