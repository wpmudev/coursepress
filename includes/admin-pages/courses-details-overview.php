...
//}
                                    ...
                                    <div class="limited_courses_message">
                                        <?php
                                        printf(__('You can create only %s course with Standard version of %s. Please upgrade to the %s.'), $wp_course_search->courses_per_page, $this->name, '<a href="http://premium.wpmudev.org/project/coursepress-pro/">' . __('PRO version') . '</a>');
                                        ?>
                                    </div>
                                    <?php
                                }
