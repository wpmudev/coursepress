...
<div class="wrap nosubsub discussions-details cp-wrap">
	...
	<h2><?php _e( 'Discussion', 'coursepress_base_td' ); ?><?php if ( current_user_can( 'manage_options' ) || current_user_can( 'coursepress_create_discussion_cap' ) || current_user_can( 'coursepress_create_my_discussion_cap' ) || current_user_can( 'coursepress_create_my_assigned_discussion_cap' ) ) { ?>
					...
					<div id='edit-sub' class='course-holder-wrap'>
						<div class='course-holder'>
							<div class='course-details'>
								<label for='discussion_name'><?php _e( 'Discussion Title', 'coursepress_base_td' ); ?></label>
								...
								<br/><br/>
								<label for='course_name'><?php _e( 'Discussion Content', 'coursepress_base_td' ); ?></label>
								<?php
