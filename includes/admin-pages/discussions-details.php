...
<div class="wrap nosubsub discussions-details cp-wrap">
	...
	<h2><?php _e( 'Discussion', 'coursepress' ); ?><?php if ( current_user_can( 'manage_options' ) || current_user_can( 'coursepress_create_discussion_cap' ) || current_user_can( 'coursepress_create_my_discussion_cap' ) || current_user_can( 'coursepress_create_my_assigned_discussion_cap' ) ) { ?>
					...
					<div id='edit-sub' class='course-holder-wrap'>
						<div class='course-holder'>
							<div class='course-details'>
								<label for='discussion_name'><?php _e( 'Discussion Title', 'coursepress' ); ?></label>
								...
								<br/><br/>
								<label for='course_name'><?php _e( 'Discussion Content', 'coursepress' ); ?></label>
								<?php
								...
								<div class="buttons">
									...
									if ( $available_course_options > 0 ) {
										?>
										<input type="submit" value="<?php ( $discussion_id == 0 ? _e( 'Create', 'coursepress' ) : _e( 'Update', 'coursepress' ) ); ?>" class="button-primary"/>
									<?php
									} else {
