...
$instructor_capabilities_students = array(
    ...
    'coursepress_unenroll_students_cap' => __('Un-enroll students from any course', 'cp'),
    'coursepress_unenroll_my_students_cap' => __('Un-enroll students from courses made by the instructor only', 'cp'),
