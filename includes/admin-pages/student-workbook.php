																	...
																	if ( $general_col_visibility ) {
																		...
																		<td class="column-response <?php echo $style . ' ' . $visibility_class; ?>">
																			...
																			if ( count( $response ) >= 1 ) {
																				...
																				<a class="assessment-view-response-link button button-units" href="<?php echo admin_url( 'admin.php?page=assessment&course_id=' . $current_course_id . '&unit_id=' . $unit->ID . '&user_id=' . $user_object->ID . '&module_id=' . $mod->ID . '&response_id=' . $response->ID . '&assessment_page=' . $assessment_page ); ?>"><?php _e( 'View', 'coursepress' ); ?></a>
