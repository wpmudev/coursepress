...
if ( ! class_exists( 'CP_Automessage_Integration' ) ) {
	...
	class CP_Automessage_Integration {
		...
		function add_new_hooks( $hooks ) {
			...
			$hooks['student_enrolled_instructor_notification']                     = array( 'action_nicename' => __( 'Student Enrolled - Instructor(s) Notification', '<%= wpmudev.plugin.textdomain %>' ) );
			...
			$hooks['student_enrolled_student_notification']                     = array( 'action_nicename' => __( 'Student Enrolled - Student Notification', '<%= wpmudev.plugin.textdomain %>' ) );
			...
			$hooks['student_response_required_grade_instructor_notification']                     = array( 'action_nicename' => __( 'Student Submitted Answer - Instructor(s) Notification', '<%= wpmudev.plugin.textdomain %>' ) );
			...
			$hooks['student_response_not_required_grade_instructor_notification']                     = array( 'action_nicename' => __( 'Student Submitted Answer (automatically graded) - Instructor(s) Notification', '<%= wpmudev.plugin.textdomain %>' ) );
			...
			$hooks['student_withdraw_from_course_instructor_notification']                     = array( 'action_nicename' => __( 'Student Withdraw from a Course - Instructor(s) Notification', '<%= wpmudev.plugin.textdomain %>' ) );
			...
			$hooks['student_withdraw_from_course_student_notification']                     = array( 'action_nicename' => __( 'Student Withdraw from a Course - Student Notification', '<%= wpmudev.plugin.textdomain %>' ) );
			...
			$hooks['new_discussion_added_instructor_notification']                     = array( 'action_nicename' => __( 'New Discussion Added to a Course - Instructor(s) Notification', '<%= wpmudev.plugin.textdomain %>' ) );
			...
			$hooks['new_discussion_added_student_notification']                     = array( 'action_nicename' => __( 'New Discussion Added to a Course - Student(s) Notification', '<%= wpmudev.plugin.textdomain %>' ) );
