...
class file_module extends Unit_Module {
	...
	function admin_main( $data ) {
		...
		<div class="<?php if ( empty( $data ) ) { ?>draggable-<?php } ?>module-holder-<?php echo $this->name; ?> module-holder-title" <?php if (empty( $data )) { ?>style="display:none;"<?php } ?>>
			...
			<div class="module-content">
				...
				<label class="bold-label"><?php _e( 'Element Title', 'coursepress' ); ?></label>
				...
				<div class="file_url_holder">
					<label><?php _e( 'Link Text', 'coursepress' ); ?>
						<input type="text" name="<?php echo $this->name; ?>_link_text[]" value="<?php echo esc_attr( isset( $data->link_text ) ? $data->link_text : __( 'Download', 'coursepress' ) ); ?>"/>
					</label>

					<label><?php _e( 'Enter a URL or Browse for a file.', 'coursepress' ); ?>
						...
						<input class="file_url_button" type="button" value="<?php _e( 'Browse', 'coursepress' ); ?>"/>
					</label>
				</div>
	...
	function on_create() {
		...
		$this->description = __( 'Ask students to upload a file. Useful if students need to send you various files like essays, homework etc.', 'coursepress' );
		$this->label       = __( 'File Download', 'coursepress' );
