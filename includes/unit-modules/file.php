...
class file_module extends Unit_Module {
		...
		<div class="<?php if ( empty( $data ) ) { ?>draggable-<?php } ?>module-holder-<?php echo $this->name; ?> module-holder-title" <?php if (empty( $data )) { ?>style="display:none;"<?php } ?>>
			...
			<div class="module-content">
				...
				<div class="file_url_holder">
					<label><?php _e( 'Link Text', '<%= wpmudev.plugin.textdomain %>' ); ?>
						<input type="text" name="<?php echo $this->name; ?>_link_text[]" value="<?php echo esc_attr( isset( $data->link_text ) ? $data->link_text : __( 'Download', '<%= wpmudev.plugin.textdomain %>' ) ); ?>"/>
					</label>

					<label><?php _e( 'Enter a URL or Browse for a file.', '<%= wpmudev.plugin.textdomain %>' ); ?>
						...
						<input class="file_url_button" type="button" value="<?php _e( 'Browse', '<%= wpmudev.plugin.textdomain %>' ); ?>"/>
					</label>
				</div>
	...
	function on_create() {
		...
		$this->description = __( 'Ask students to upload a file. Useful if students need to send you various files like essays, homework etc.', '<%= wpmudev.plugin.textdomain %>' );
		$this->label       = __( 'File Download', '<%= wpmudev.plugin.textdomain %>' );
