...
class image_module extends Unit_Module {
		...
		<div class="<?php if ( empty( $data ) ) { ?>draggable-<?php } ?>module-holder-<?php echo $this->name; ?> module-holder-title" <?php if (empty( $data )) { ?>style="display:none;"<?php } ?>>
			...
			<div class="module-content">
				...
				<div class="file_url_holder">
					<label><?php _e( 'Enter a URL or Browse for an image.', 'coursepress' ); ?>
						...
						<input class="image_url_button" type="button" value="<?php _e( 'Browse', 'coursepress' ); ?>"/>
	...
	function on_create() {
		...
		$this->description = __( 'Image, 100% width', 'coursepress' );
		$this->label       = __( 'Image', 'coursepress' );
	...
	function show_media_caption( $data ) {
		...
		<div class="caption-settings">
			<label class="show_media_caption">
				...
				<span class="element_title_description"><?php _e( 'Show a caption for this image.', 'coursepress' ); ?></span>
			</label>
