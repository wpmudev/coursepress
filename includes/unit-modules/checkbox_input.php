...
// $data->gradable_answer
	...
	function admin_main( $data ) {
		...
		$answer_checkbox_message = __( 'Please mark the correct answer.', 'coursepress_base_td' );
		...
		if ( isset( $data->ID ) ) {
			...
			if ( ! empty( $data->answers ) ) {
				foreach ( $data->answers as $answer ) {
					...
					<tr>
						<td width="96%">
							<input class="checkbox_answer_check" type="checkbox" id="<?php echo $this->name . '_checkbox_check[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][]'; ?>" name="<?php echo $this->name . '_checkbox_check[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][]'; ?>" value='<?php echo esc_attr( ( isset( $answer ) ? $answer : '' ) ); ?>' <?php
							if ( is_array( $data->checked_answers ) && in_array( $answer, $data->checked_answers ) ) {
								echo 'checked';
							}
							?> required data-msg-required="<?php echo $answer_checkbox_message; ?>"/>
							<input class="checkbox_answer" type="text" id="<?php echo $this->name . '_checkbox_answers[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][' . $answer_cnt . ']'; ?>" name="<?php echo $this->name . '_checkbox_answers[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][' . $answer_cnt . ']'; ?>" value='<?php echo esc_attr( ( isset( $answer ) ? $answer : '' ) ); ?>'  required data-msg-required="<?php echo $answer_field_message; ?>" data-unique-id="<?php echo $answer_cnt; ?>"/>
			...
			<tr>
				<td width="96%">
					<input class="checkbox_answer_check" type="checkbox" id="<?php echo $this->name . '_checkbox_check[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][]'; ?>" name="<?php echo $this->name . '_checkbox_check[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][]'; ?>" checked required data-msg="<?php echo $answer_checkbox_message; ?>"/>
					<input class="checkbox_answer" type="text" id="<?php echo $this->name . '_checkbox_answers[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][0]'; ?>" name="<?php echo $this->name . '_checkbox_answers[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][0]'; ?>" required data-msg="<?php echo $answer_field_message; ?>" data-unique-id="0"/>
				</td>
				<td width="3%">&nbsp;</td>
			</tr>
			...
			<tr>
				<td width="96%">
					<input class="checkbox_answer_check" type="checkbox" id="<?php echo $this->name . '_checkbox_check[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][]'; ?>" name="<?php echo $this->name . '_checkbox_check[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][]'; ?>" required data-msg="<?php echo $answer_checkbox_message; ?>"/>
					<input class="checkbox_answer" type="text" id="<?php echo $this->name . '_checkbox_answers[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][1]'; ?>" name="<?php echo $this->name . '_checkbox_answers[' . ( isset( $data->module_order ) ? $data->module_order : 999 ) . '][1]'; ?>" required data-msg="<?php echo $answer_field_message; ?>" data-unique-id="1"/>
				</td>
				<td width="3%">&nbsp;</td>
			</tr>
		<?php
