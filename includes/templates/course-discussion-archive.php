...
?>
	...
	<h2><?php _e( 'Discussions', '<%= wpmudev.plugin.textdomain %>' ); ?></h2>
	...
	<div class="discussion-controls">
		...
		<button data-link="<?php echo esc_url( $url ); ?>"><?php _e( 'Ask a Question', '<%= wpmudev.plugin.textdomain %>' ); ?></button>
	</div>
			...
			while ( have_posts() ) : the_post();
				...
				<li>
					<div class="discussion-archive-single-meta">
						...
						?>">
							<span class="comments-count"><?php echo get_comments_number(); ?> <?php _e( 'Comments', '<%= wpmudev.plugin.textdomain %>' ); ?></span>
						</div>
					</div>
					<div class="discussion-archive-single">
						...
						<div class="discussion-meta">
							...
							<span><?php echo get_comments_number(); ?> <?php _e( 'Comments', '<%= wpmudev.plugin.textdomain %>' ); ?></span>
						</div>
