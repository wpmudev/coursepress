...
<form id="new_question_form" name="new_question_form" method="post" class="new_question_form">
	<div class="add_new_discussion">
		...
		<div class="new_question">
			<div class="rounded"><span><?php _e( 'Question', 'coursepress' ); ?></span></div>
			...
			<a href="<?php echo esc_url( $url ); ?>" class="button_cancel"><?php _e( 'Cancel', 'coursepress' ); ?></a>
