<?php if (current_user_can('student')) { ?>
    ...
    foreach ($student_courses as $course_id) {
        ...
        <div class="course">
            ...
            ?><br />
            <span class="strong"><?php _e('Enrollment Dates: ', 'cp'); ?></span><?php if (do_shortcode('[course_details field="enrollment_start_date" course_id="' . $course_details->ID . '"]') == 'Open-ended') {
                _e('Open-ended', 'cp');
            } else {
