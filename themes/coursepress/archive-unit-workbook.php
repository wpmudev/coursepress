            ...
            while ( have_posts() ) {
                ...
                <div class="workbook_units">
                    <div class="unit_title">
                        <h3><?php the_title(); ?>
                            <span><?php if ( do_shortcode('[course_unit_details field="assessable_input_modules_count"]') > 0 ) {
            _e('Grade:', 'cp'); ?> <?php echo apply_filters('cp_grade', do_shortcode('[course_unit_details field="student_unit_grade" unit_id="' . get_the_ID() . '"]')); ?>%<?php } ?></span>
                        </h3>
                    </div>
