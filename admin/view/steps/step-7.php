<div class="step-title step-7">
	<?php _e( 'Step 7 &ndash; Course Completion', 'CP_TD' ); ?>
...
<div class="cp-box-content step-content step-7">
	...
	<div class="wide minimum-grade">
		<label class="required" for="meta_minimum_grade_required"><?php _e( 'Minimum Grade Required', 'CP_TD' ); ?></label>
		...
		<p class="description"><?php _e( 'The minimum grade required to marked course completion and send course certficates.', 'CP_TD' ); ?></p>
	</div>

	<!-- Course Pre Completion Page -->
	<div class="wide page-pre-completion">
		<label><?php _e( 'Pre-Completion Page', 'CP_TD' ); ?></label>
		<p class="description"><?php _e( 'Use the fields below to show custom pre-completion page after the student completed the course but require final assessment from instructors.', 'CP_TD' ); ?></p>

		<label for="meta_pre_completion_title" class="required"><?php _e( 'Page Title', 'CP_TD' ); ?></label>
	...
	<div class="wide page-completion">
		<label><?php _e( 'Course Completion Page', 'CP_TD' ); ?></label>
		<p class="description"><?php _e( 'Use the fields below to show a custom page after successfull course completion.', 'CP_TD' ); ?></p>
		<label for="meta_course_completion_title" class="required"><?php _e( 'Page Title', 'CP_TD' ); ?></label>
	...
	<div class="wide page-failed">
		<label><?php _e( 'Failed Page', 'CP_TD' ); ?></label>
		<p class="description"><?php _e( 'Use the fields below to display failure page when an student completed a course but fail to reach the minimum required grade.', 'CP_TD' ); ?></p>
		<label for="meta_course_failed_title" class="required"><?php _e( 'Page Title', 'CP_TD' ); ?></label>
	...
	<div class="wide course-certificate">
		<br />
		<h3><?php echo _e( 'Custom Certificate', 'CP_TD' ); ?></h3>
		<a href="<?php echo esc_url( $certificate['preview_link'] ); ?>" target="_blank" class="button button-default btn-cert <?php echo false === $certificate['enabled'] ? 'hidden' : ''; ?>" style="float:right;margin-top:-35px;">
			<?php echo _e( 'Preview', 'CP_TD' ); ?>
		</a>

		<?php
		$one = array(
			'meta_key' => 'basic_certificate',
			'label' => __( 'Use custom certificate for this course.', 'CP_TD' ),
			'default' => false,
		);
		...
		<div class="options <?php echo $certificate['enabled'] ? '' : 'hidden'; ?>">
			...
			<table class="wide">
				<tr>
					<td style="width:20%;"><label><?php _e( 'Background Image', 'CP_TD' ); ?></label></td>
					<td><?php
				...
				<tr>
					<td><label><?php _e( 'Page Orientation', 'CP_TD' ); ?></label></td>
					<td>
						<label style="float:left;margin-right:25px;">
							<input type="radio" name="meta_page_orientation" value="L" <?php checked( 'L', $certificate['orientation'] ); ?> /> <?php _e( 'Landscape', 'CP_TD' ); ?>
						</label>
