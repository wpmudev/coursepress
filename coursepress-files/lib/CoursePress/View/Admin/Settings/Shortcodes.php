...
class CoursePress_View_Admin_Settings_Shortcodes{
	...
	public static function init() {
		...
		add_action( 'coursepress_settings_process_shortcodes', array( get_class(), 'process_form' ), 10, 2 );
		add_filter( 'coursepress_settings_render_tab_shortcodes', array( get_class(), 'return_content' ), 10, 3 );
	}
