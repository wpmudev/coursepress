...
class CoursePress_Helper_Table_DiscussionList extends WP_List_Table {
	...
	public function no_items() {
		echo __( 'No discussions found.', CoursePress::TD );
	}
	...
	public function get_columns() {
		$columns = array(
			...
			'discussion' => __( 'Discussion', CoursePress::TD ),
	...
	public function column_course( $item ) {
		...
		$attributes = CoursePress_Model_Discussion::attributes( $item->ID );
		...
		<div class="alignleft actions category-filter">
			...
			if ( 'top' == $which ) {
				...
				<form method="get">
					...
					<?php $this->search_box( __( 'Search Discussions', CoursePress::TD ), 'search_discussions' ); ?>
				</form>
			<?php
			} else {
