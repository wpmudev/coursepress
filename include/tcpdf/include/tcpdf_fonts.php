...
class CP_TCPDF_FONTS {
	...
	public static function _getfontpath() {
		if (!defined('CP_K_PATH_FONTS') AND is_dir($fdir = realpath(dirname(__FILE__).'/../fonts'))) {
			if (substr($fdir, -1) != '/') {
				$fdir .= '/';
			}
			define('CP_K_PATH_FONTS', $fdir);
		}
		return defined('CP_K_PATH_FONTS') ? CP_K_PATH_FONTS : '';
	}
