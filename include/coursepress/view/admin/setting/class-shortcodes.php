...
<span class=""><?php _e( 'Display a list or count of Instructors ( gravatar, name and link to profile page )', 'CP_TD' ); ?></span>
...
<span class=""><?php _e( 'Display an instructor’s avatar.', 'CP_TD' ); ?></span>
