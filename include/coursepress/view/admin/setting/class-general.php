...
class CoursePress_View_Admin_Setting_General {
	...
	public static function return_content( $content, $slug, $tab ) {
						...
						<tbody>
							...
							<tr valign="top">
								...
								<td>' .
									...
									'<p class="description">' . sprintf( __( 'Select page where you have %s shortcode or any other set of %s. Please note that slug for the page set above will not be used if "Use virtual page" is not selected.', 'cp' ), '<strong>[cp_pages page="student_signup"]</strong>', '<a target="_blank" href="' . admin_url( 'admin.php?page=' . $_GET['page'] . '&tab=shortcodes' ) . '">' . __( 'shortcodes', 'cp' ) . '</a>' ) . '</p>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>' .
									...
									'<p class="description">' . sprintf( __( 'Select page where you have %s shortcode or any other set of %s. Please note that slug for the page set above will not be used if "Use virtual page" is not selected.', 'cp' ), '<strong>[cp_pages page="student_dashboard"]</strong>', '<a target="_blank" href="' . admin_url( 'admin.php?page=' . $_GET['page'] . '&tab=shortcodes' ) . '">' . __( 'shortcodes', 'cp' ) . '</a>' ) . '</p>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>' .
									...
									'<p class="description">' . sprintf( __( 'Select page where you have %s shortcode or any other set of %s. Please note that slug for the page set above will not be used if "Use virtual page" is not selected.', 'cp' ), '<strong>[cp_pages page="student_settings"]</strong>', '<a target="_blank" href="' . admin_url( 'admin.php?page=' . $_GET['page'] . '&tab=shortcodes' ) . '">' . __( 'shortcodes', 'cp' ) . '</a>' ) . '</p>
								</td>
							</tr>
		...
		$content .= '
				...
				<p class="description">' . __( 'Order of courses in admin and on front. If you choose "Post Order Number", you will have option to reorder courses from within the Courses admin page.', 'cp' ) . '</p>
				<div class="inside">
					<table class="form-table">
						<tbody>
							<tr valign="top">
		...
		$content .= '
									<select name="coursepress_settings[course][order_by]" class="widefat" id="course_order_by">
										<option value="post_date" ' . selected( $selected_order, 'post_date', false ) .'>' . __( 'Post Date', 'cp' ) . '</option>
										<option value="course_order" ' . selected( $selected_order, 'course_order', false ) .'>' . __( 'Post Order Number', 'cp' ) . '</option>
									</select>
								</td>
							</tr>
							<tr valign="top">
