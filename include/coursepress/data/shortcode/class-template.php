...
//$progress = CoursePress_Data_Student::get_calculated_completion_data( get_current_user_id(), $course_id );
...
?>
	 ...
	 */
	protected static function show_nav_button( $button, $title, $classes, $link_title = '' ) {
		$res = '';
