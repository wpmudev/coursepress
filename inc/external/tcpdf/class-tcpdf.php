 ...
 */
class CoursePress_External_TCPDF_TCPDF {
	...
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false) {
		...
		$this->file_id = md5(CP_TCPDF_STATIC::getRandomSeed( 'CoursePress_External_TCPDF_TCPDF' . $orientation . $unit . $serformat . $encoding));
	...
	protected function _putcatalog() {
		...
		if (!empty($this->pdflayers)) {
			...
			$out .= ' /Creator '.$this->_textstring( 'CoursePress_External_TCPDF_TCPDF', $oid);
			$out .= ' /BaseState /ON';
			$out .= ' /OFF ['.$lyrobjs_off.']';
	...
	protected function getHtmlDomArray($html) {
		...
		$blocktags = array('blockquote','br','dd','dl','div','dt','h1','h2','h3','h4','h5','h6','hr','li','ol','p','pre','ul',
            'CoursePress_External_TCPDF_TCPDF','table','tr','td');
...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	...
	protected function openHTMLTagHandler($dom, $key, $cell) {
		...
		switch($tag['value']) {
			...
			case 'CoursePress_External_TCPDF_TCPDF': {
		...
		$bordertags = array('blockquote','br','dd','dl','div','dt','h1','h2','h3','h4','h5','h6','hr','li','ol','p','pre','ul',
            'CoursePress_External_TCPDF_TCPDF','table');
	 ...
	 *
	 * @return CoursePress_External_TCPDF_TCPDF object.
	 * @public
	 * @since 4.5.029 (2009-03-19)
	 */
