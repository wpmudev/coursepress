	...
	var conf = {
		...
		plugin_branches: {
			exclude_pro: [
				...
				'../release/README.md',
				'../release/readme.txt',
				'../release/themes/coursepress/.git',
				'../release/themes/coursepress/Gruntfile.js',
				'../release/themes/coursepress/README.md'
			],
			exclude_free: [
				'../release/docs',
				'../release/test',
		...
		copy: {
			release: {
				...
				src: [
					...
					'!inc/external/wpmu-lib/.git*',
					'!inc/external/wpmu-lib/Gruntfile.js',
					'!inc/external/wpmu-lib/license.txt',
					'!inc/external/wpmu-lib/node_modules/*',
					'!inc/external/wpmu-lib/node_modules/**',
					'!inc/external/wpmu-lib/node_modules',
					'!inc/external/wpmu-lib/package.json',
					'!inc/external/wpmu-lib/README.md',
					'!inc/external/wpmu-lib/test/*',
					'!inc/external/wpmu-lib/test/**',
					'!inc/external/wpmu-lib/test',
					'!inc/external/wpmu-lib/css/sass',
					'!inc/external/wpmu-lib/css/sass/*',
					'!inc/external/wpmu-lib/css/sass/**',
					'!themes/coursepress/.git*',
					'!themes/coursepress/Gruntfile.js',
					'!themes/coursepress/node_modules/*',
					'!themes/coursepress/node_modules/**',
					'!themes/coursepress/node_modules',
					'!themes/coursepress/tests/*',
					'!themes/coursepress/tests/**',
					'!themes/coursepress/tests',
					'!themes/coursepress/README.md'
				],
				dest: '../release',
				noEmpty: true
			},
		...
		checktextdomain: {
			...
			files: {
				src: [
                    ...
                    'views/**/*.php',
                    'templates/**/*.php',
                    '!inc/external/wpmu-lib/inc/class-thelib-*',
                ],
				expand: true,
			},
		},
