                ...
                if (isset($meta["mp_price"]) && $meta["mp_price"]) {
                    ...
                    foreach ($meta["mp_price"] as $key => $price) {
                        ...
                        <tr class="variation">
                            ...
                            <td class="mp_custom_field_col"><input type="checkbox" class="mp_has_custom_field" name="mp_has_custom_field[<?php echo $key; ?>]" value="1" <?php checked(!defined('MP_LITE') && isset($meta['mp_has_custom_field'][$key]) && $meta['mp_has_custom_field'][$key]);
                echo defined('MP_LITE') ? ' disabled="disabled"' : ''; ?> /></td>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="description"><?php _e('Select which calculated shipping methods the customer will be able to choose from:', 'mp') ?></span><br />
                                                        ...
                                                        foreach ((array) $mp_shipping_plugins as $code => $plugin) {
                                                            ...
                                                            echo defined('MP_LITE') ? ' disabled="disabled"' : ''; ?> /> <?php echo esc_attr($plugin[1]); ?></label><br /><?php
                                            }
                                            ?>
                                                </td>
                                            </tr>
